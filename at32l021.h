...
#if !defined (AT32L021C8T7)   && !defined (AT32L021K8T7)   && !defined (AT32L021K8U7)   && \
    !defined (AT32L021K8U7_4) && !defined (AT32L021F8U7)   && !defined (AT32L021F8P7)   && \
    !defined (AT32L021G8U7)   && !defined (AT32L021C6T7)   && !defined (AT32L021K6T7)   && \
    !defined (AT32L021K6U7)   && !defined (AT32L021K6U7_4) && !defined (AT32L021F6U7)   && \
    !defined (AT32L021F6P7)   && !defined (AT32L021G6U7)   && !defined (AT32L021C4T7)   && \
    !defined (AT32L021K4T7)   && !defined (AT32L021K4U7)   && !defined (AT32L021K4U7_4) && \
    !defined (AT32L021F4U7)   && !defined (AT32L021F4P7)   && !defined (AT32L021G4U7)

    #error "Please select first the target device used in your application (in at32l021.h file)"
#endif
...
/**
  * define with package
  */
#if defined (AT32L021C8T7)   || defined (AT32L021C6T7)   || defined (AT32L021C4T7)

    #define AT32L021Cx
#endif

#if defined (AT32L021K8T7)   || defined (AT32L021K8U7)   || defined (AT32L021K8U7_4) || \
    defined (AT32L021K6T7)   || defined (AT32L021K6U7)   || defined (AT32L021K6U7_4) || \
    defined (AT32L021K4T7)   || defined (AT32L021K4U7)   || defined (AT32L021K4U7_4)

    #define AT32L021Kx
#endif

#if defined (AT32L021G8U7)   || defined (AT32L021G6U7)   || defined (AT32L021G4U7)

    #define AT32L021Gx
#endif

#if defined (AT32L021F8U7)   || defined (AT32L021F8P7)   || defined (AT32L021F6U7)   || \
    defined (AT32L021F6P7)   || defined (AT32L021F4U7)   || defined (AT32L021F4P7)
...
/**
  ...
  */
#if defined (AT32L021C4T7)   || defined (AT32L021K4T7)   || defined (AT32L021K4U7)   || \
    defined (AT32L021K4U7_4) || defined (AT32L021F4U7)   || defined (AT32L021F4P7)   || \
    defined (AT32L021G4U7)

    #define AT32L021x4
#endif

#if defined (AT32L021C6T7)   || defined (AT32L021K6T7)   || defined (AT32L021K6U7)   || \
    defined (AT32L021K6U7_4) || defined (AT32L021F6U7)   || defined (AT32L021F6P7)   || \
    defined (AT32L021G6U7)
...
/**
  * @brief at32l021 standard peripheral library version number
  */
#define __AT32L021_LIBRARY_VERSION_MAJOR    (0x02) /*!< [31:24] major version */
#define __AT32L021_LIBRARY_VERSION_MIDDLE   (0x00) /*!< [23:16] middle version */
#define __AT32L021_LIBRARY_VERSION_MINOR    (0x07) /*!< [15:8]  minor version */
#define __AT32L021_LIBRARY_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __AT32L021_LIBRARY_VERSION          ((__AT32L021_LIBRARY_VERSION_MAJOR << 24)  | \
                                             (__AT32L021_LIBRARY_VERSION_MIDDLE << 16) | \
                                             (__AT32L021_LIBRARY_VERSION_MINOR << 8)   | \
                                             (__AT32L021_LIBRARY_VERSION_RC))
...
/**
  ...
  */
#define __CM0PLUS_REV             0x0001U  /*!< core revision r0p0                           */
#define __MPU_PRESENT             1        /*!< mpu present                                  */
#define __VTOR_PRESENT            1        /*!< Vector  Table  Register supported            */
#define __NVIC_PRIO_BITS          2        /*!< at32 uses 2 bits for the priority levels     */
#define __Vendor_SysTickConfig    0        /*!< set to 1 if different systick config is used */

/**
  * @brief at32l021 interrupt number definition, according to the selected device
...
typedef enum IRQn
{
    ...
    HWDIV_IRQn                  = 8,      /*!< hardware divider interrupt                           */
    ...
    USART4_3_IRQn               = 29,     /*!< usart4 and usart3 global interrupt                   */
...
#define DEBUG_BASE                       ((uint32_t)0x40015800)
...
#define HWDIV_BASE                       (AHBPERIPH1_BASE + 0x10000)
